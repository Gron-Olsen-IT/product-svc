...
public class ProductRepositoryGet
{
    ...
    List<Product> testData = new List<Product>
            {
                new Product ("0", "Bil", "Ny bil", "10", 200, DateTime.Now, ProductStatus.Active),
                new Product ("1", "Taske", "Med fire rum", "3", 389, DateTime.Now, ProductStatus.Active),
                new Product ("2", "Anhængertræk", "Til alle biler", "1", 1000, DateTime.Now, ProductStatus.Active ),
                new Product ("3", "Hus", "Nyt hus med fire toiletter", "11", 500, DateTime.Now, ProductStatus.Active ),
            };
